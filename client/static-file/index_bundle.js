...
var Main = function (_React$Component) {
    ...
    function Main(props) {
        ...
        _this.updatePeopleList = function (data) {
            _this.setState({
                peopleList: data
            });
        };
        ...
        _this.get = function () {
            var updatePeopleList = _this.updatePeopleList;
...
var InputForm = function (_React$Component) {
    ...
    function InputForm(props) {
        ...
        _this.handleChange = function (variable, value, valid) {
            _this.setState(_defineProperty({}, variable, { value: value, valid: valid }));
        };
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_InputField2.default, {
                    ...
                    validateList: [{ regExp: '^.{0,0}$', check: true, validateMessage: "your firstname can't be empty" }, { regExp: '(?:^| )[a-z]', check: true, validateMessage: "your firstname must be capitalized" }],
                ...
                _react2.default.createElement(_InputField2.default, {
                    ...
                    validateList: [{ regExp: '^.{0,0}$', check: true, validateMessage: "your lastname can't be empty" }, { regExp: '(?:^| )[a-z]', check: true, validateMessage: "your lastname must be capitalized" }],
                    handleChange: this.handleChange
                }),
                _react2.default.createElement(
                    'button',
...
var inputField = function (_React$Component) {
    ...
    function inputField(props) {
        ...
        _this.validate = function (value) {
            var validateList = _this.props.validateList;
            for (var i = 0; i < validateList.length; ++i) {
                var RegularExp = new RegExp(validateList[i].regExp);
        ...
        _this.handleInputChange = function (event) {
            ...
            newValue = newValue.split(" ").filter(function (w) {
                return w != "";
            }).join(' ');

            var validateMessage = _this.validate(newValue);
            _this.setState({
                validateMessage: validateMessage
            }, _this.props.handleChange(_this.props.variable, newValue, _this.state.validateMessage === 'Valid Input'));
        };
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        null,
                        state.validateMessage != '' && _react2.default.createElement(
                            'p',
                            null,
